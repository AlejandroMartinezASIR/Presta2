...
# Instalamos dependencias de Nginx
sudo apt install software-properties-common -y
sudo add-apt-repository ppa:ondrej/php -y
sudo apt update
sudo apt install php7.4 php7.4-cli  php7.4-xml php7.4-curl php7.4-gd php7.4-mbstring php7.4-zip php7.4-intl -y
...
cp /home/ubuntu/Presta2/conf/load-balancer.conf /etc/nginx/sites-available
